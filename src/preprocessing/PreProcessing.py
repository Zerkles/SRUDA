...
matrix=test.load_data(path_data_dir+"/criteo/CriteoSearchDataCategorized.csv",0.01)
...
features_choosen=test.choose_feature(["sfm_lr","sfm_linearsvc","sfm_rfc","sfm_lasso","rle_lr","rle_linearsvc","rle_rfc","rle_lasso","permutation_rfc", "permutation_lasso"],X,Y,columns[3:],10000)
...
analysis.check_if_Sale_0_price_0(matrix)
